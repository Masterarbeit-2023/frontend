...
const RoomInfoCard = (props: RoomInfoCardProps) => {
    ...
    const handleSelectRoom = (room: Room, rate: Rate) => {
        props.handleSelectRoom(props.roomNumber, room, rate);
    }
    ...
    return (
        <div className={"shadow rounded-lg"}>
            ...
            <Modal open={isModalOpen} onOk={handleOk} onCancel={handleClose} footer={[,
                ...
                <RoomRateModal room={room} roomImage={props.roomImage} handleSelectRoom={handleSelectRoom}
                               selectedRate={props.bookingRooms[props.roomNumber].rate}/>
            </Modal>
        </div>
    );
};
